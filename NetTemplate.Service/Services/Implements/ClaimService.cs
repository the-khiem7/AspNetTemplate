...
using Claim = NetTemplate.DAL.Data.Entities.Claim;

namespace NetTemplate.BLL.Services.Implements
{
    public class ClaimService : BaseService<Claim>, IClaimService
    {
        ...
        public async Task<bool> ApproveClaim(ClaimsPrincipal user, Guid id)
        {
            ...
            var projectRepo = _unitOfWork.GetRepository<NetTemplate.DAL.Data.Entities.Project>();
